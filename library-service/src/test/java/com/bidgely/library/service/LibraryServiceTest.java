...
class LibraryServiceTest {
    ...
    void setUp() throws Exception {
        ...
        testBook = new Book("9780134685991", "Effective Java", "Joshua Bloch",
                           "Addison-Wesley", 2018, 5, BookCategory.TECHNOLOGY);
        
        testMember = new Member("M001", "John Doe", "john.doe@example.com",
    ...
    void testAddBook_success() throws Exception {
        Book newBook = new Book("9780132350884", "Clean Code", "Robert Martin",
                               "Prentice Hall", 2008, 3, BookCategory.TECHNOLOGY);
    ...
    void testAddBook_withInvalidIsbn() {
        Book invalidBook = new Book("invalid", "Test", "Author",
                                   "Publisher", 2020, 1, BookCategory.FICTION);
    ...
    void testAddBook_withEmptyTitle() {
        Book invalidBook = new Book("9780134685991", "", "Author",
                                   "Publisher", 2020, 1, BookCategory.FICTION);
        assertThatThrownBy(() -> libraryService.addBook(invalidBook))
                .isInstanceOf(InvalidInputException.class)
    ...
    void testAddBook_withInvalidYear() {
        Book invalidBook = new Book("9780134685991", "Test", "Author",
                                   "Publisher", 999, 1, BookCategory.FICTION);
        assertThatThrownBy(() -> libraryService.addBook(invalidBook))
                .isInstanceOf(InvalidInputException.class)
    ...
    void testUpdateBook_notFound() {
        Book newBook = new Book("9999999999999", "Test", "Author",
                               "Publisher", 2020, 1, BookCategory.FICTION);
    ...
    void testRegisterMember_success() throws Exception {
        Member newMember = new Member("M002", "Jane Doe", "jane.doe@example.com",
                                     "9876543210", LocalDate.now(), MembershipType.BASIC);
    ...
    void testRegisterMember_withInvalidEmail() {
        Member invalidMember = new Member("M002", "Jane Doe", "invalid-email",
                                         "9876543210", LocalDate.now(), MembershipType.BASIC);
    ...
    void testRegisterMember_withInvalidPhone() {
        Member invalidMember = new Member("M002", "Jane Doe", "jane@example.com",
                                         "123", LocalDate.now(), MembershipType.BASIC);
        assertThatThrownBy(() -> libraryService.registerMember(invalidMember))
                .isInstanceOf(InvalidInputException.class)
    ...
    void testIssueBook_exceedsLoanLimit() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            Book book = new Book("978013468599" + i, "Book " + i, "Author",
                               "Publisher", 2020, 2, BookCategory.FICTION);
            libraryService.addBook(book);
            libraryService.issueBook("M001", "978013468599" + i);
        }

        Book extraBook = new Book("9780134685995", "Extra Book", "Author",
                                 "Publisher", 2020, 1, BookCategory.FICTION);
    ...
    void testCalculateFine_withOverdue() {
        Loan overdueLoan = new Loan("L001", "M001", "9780134685991",
