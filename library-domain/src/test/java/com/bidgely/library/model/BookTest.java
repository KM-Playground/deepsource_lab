...
class BookTest {
    ...
    void testEquals_sameIsbn() {
        Book book2 = new Book("978-0-13-468599-1", "Different Title", "Different Author",
                             "Different Publisher", 2020, 3, BookCategory.FICTION);
        assertThat(book).isEqualTo(book2);
    }

    @Test
    void testEquals_differentIsbn() {
        Book book2 = new Book("978-0-13-468599-2", "Effective Java", "Joshua Bloch",
                             "Addison-Wesley", 2018, 5, BookCategory.TECHNOLOGY);
